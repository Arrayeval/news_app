    ...
    return  (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.headContainer}>
          {/*夜间.签到*/}
          <View style={styles.headTopCotainer}>
            <TouchableOpacity style={style.topBtnStyle} activeOpacity={0.9} onPress={() => {alert('夜间')}}>
              <Image  souce={require('./../../assets/images/i_night.png')} style={styles.headTopImg} resizeMode={'contain'}/>
              <Text style={styles.headTopText}>夜间</Text>
            </TouchableOpacity>
            <TouchableOpacity style={style.topBtnStyle} activeOpacity={0.9} onPress={() => {alert("签到")}}>
          ...
          <View style={styles.headCenterContainer}>
            ...
            <View style={styles.positionContainer}>
              <Image styles= {styles.positionImg} source={require('./../../assets/images/i_bookmark.png')}/>
              <Text style={styles.positionText}>跟帖</Text>
            </View>
            {/* 收藏、历史、更贴 */}
